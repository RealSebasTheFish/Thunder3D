...
public class Shader {
    ...
    public void uploadMat4f(String varName, Matrix4f mat4) {
        ...
        mat4.get(matBuffer); // Put stuff into buffer
    ...
    public void uploadMat3f(String varName, Matrix3f mat3) {
        int varLocation = glGetUniformLocation(shaderProgramID, varName); // Targets uniform var inside of shader file
        use();
        FloatBuffer matBuffer = BufferUtils.createFloatBuffer(9); // 16 Becase it is a 4x4 matrix
        mat3.get(matBuffer); // Put stuff into buffer
